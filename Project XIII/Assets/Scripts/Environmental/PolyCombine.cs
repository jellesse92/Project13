...
public class PolyCombine
{
    ...
    public List<List<Vector2>> UniteCollisionPolygons(List<List<Vector2>> polygons)
    {
        ...
        offset.Execute(ref solution, 0f);
    ...
    public void CreateLevelCollider(GameObject parent, List<List<Vector2>> polygons)
    {
        GameObject colliderObj = parent;
       // colliderObj.layer = parent.layer;

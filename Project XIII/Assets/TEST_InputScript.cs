...
public class TEST_InputScript : MonoBehaviour {
	...
	void Update () {
        ...
        if(Input.GetAxis("1_LeftJoyStickX") != 0)
            Debug.Log("Getting P1 - LeftX: " + Input.GetAxis("LeftJoyStickX1"));
        if(Input.GetAxis("1_LeftJoyStickY") != 0)
            Debug.Log("Getting P1 - LeftY: " + Input.GetAxis("LeftJoyStickY1"));
        if (Input.GetAxis("1_RightJoyStickX") != 0)
            Debug.Log("Getting P1 - RightX: " + Input.GetAxis("RightJoyStickX1"));
        if (Input.GetAxis("1_RightJoyStickY") != 0)
            Debug.Log("Getting P1 - RightY: " + Input.GetAxis("RightJoyStickY1"));
            */
